...
class OffersRestTemplateErrorsIntegrationTest {
    ...
    JobOffersRestTemplateConfigurationProperties properties = new JobOffersRestTemplateConfigurationProperties(1000, 1000, "http://localhost", wireMockServer.getPort());
    JobOfferFetchable offerFetchable = new OffersRestTemplateIntegrationTestConfig(properties).remoteJobOfferClient();
